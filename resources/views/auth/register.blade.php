...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            {{-- Gender --}}
                            <div class="row mb-3 ">
                                <label for="radio_button_gender" class="col-md-4 col-form-label text-md-end"
                                    required>{{ __('Gender') }}</label>

                                <div class="d-flex flex-column col-md-6">
                                    {{-- what the hell, how to le validate a radio button???? kalo bisa bantu gw ngertiin radio button validation ren --}}
                                    <div class="d-inline-flex">
                                        <input
                                            class="form-check-input me-1 @error('radio_button_gender') is-invalid @enderror"
                                            type="radio" name="radio_button_gender" id="Male" value="Male">
                                    ...
                                    <div class="d-inline-flex">
                                        <input
                                            class="form-check-input me-1 @error('radio_button_gender') is-invalid @enderror"
                                            type="radio" name="radio_button_gender" id="Female" value="Female">
                            ...
                            <div class="row mb-3 ">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="date form-control @error('DOB') is-invalid @enderror" name="DOB"
                                        style="float:right" type="text" data-toggle="tooltip" title="yy-mm-dd" required>
                                    @error('DOB')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary" onclick="genderValid()">
                                        {{ __('Register') }}
                                    </button>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function genderValid() {
            var gender = document.getElementsByName("radio_button_gender");
            var valid = false;
            var i = 0;
            ...
            if (!valid) alert("Gender must be filled!");
            return valid;
        }
    </script>
@endsection
